...
namespace VirtualGuide.WebApi.WebApi
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            IdentityUser user = await ApplicationUserManager.FindByIdAsync(User.Identity.GetUserId());
        ...
        public async Task<IHttpActionResult> ChangePassword(ChangePasswordBindingModel model)
        {
            ...
            IdentityResult result = await ApplicationUserManager.ChangePasswordAsync(User.Identity.GetUserId(), model.OldPassword,
                model.NewPassword);
        ...
        public async Task<IHttpActionResult> AddExternalLogin(AddExternalLoginBindingModel model)
        {
            ...
            IdentityResult result = await ApplicationUserManager.AddLoginAsync(User.Identity.GetUserId(),
        ...
        public async Task<IHttpActionResult> RemoveLogin(RemoveLoginBindingModel model)
        {
            ...
            {
                result = await ApplicationUserManager.RemovePasswordAsync(User.Identity.GetUserId());
            }
            else
            {
                result = await ApplicationUserManager.RemoveLoginAsync(User.Identity.GetUserId(),
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            User user = await ApplicationUserManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
            ...
            if (hasRegistered)
            {
                ...
                ClaimsIdentity cookieIdentity = await user.GenerateUserIdentityAsync(ApplicationUserManager,
